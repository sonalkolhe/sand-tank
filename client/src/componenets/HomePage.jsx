...
import { ThreeDCardDemo } from "./UIelements/3d-card.tsx";
import { ImagesSliderDemo } from "./UIelements/3d-image-slide.tsx";
...
function Hero() {
  ...
  const images = [
    ...
    "https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fwallpapercave.com%2Fwp%2Fwp2599594.jpg&f=1&nofb=1&ipt=d5deefd933bb1174916d8302663e3a2e07122e7e40665b3da77112a41f8f0de4&ipo=images",
  ];
  ...
  return (
    <div className='relative w-full h-full overflow-hidden pt-20'>
      {images.map((image, index) => (
        <div
          key={index}
          className={` w-full h-[70vh] transition-opacity duration-1000 ${
          ...
          />
          <p className='absolute bottom-0 z-10 mb-4 ml-10 text-center text-3xl font-bold uppercase text-stone-50 shadow-2xl backdrop-blur-sm text-white'>
            {" "}
            this is some para for the some text
          </p>
        </div>
      ))}
      <button
        className='absolute top-1/2 left-0 transform -translate-y-1/2 z-10 bg-gray-800 bg-opacity-50 text-white rounded-full p-2 hover:bg-opacity-75'
        onClick={prevSlide}>
        ⬅️
      </button>
      <button
        className='absolute top-1/2 right-0 transform -translate-y-1/2 z-10 bg-gray-800 bg-opacity-50 text-white rounded-full p-2 hover:bg-opacity-75'
        onClick={nextSlide}>
        ➡️
      </button>
    </div>
...
function Work() {
  ...
  return (
    <div id='work' className='p-4 md:p-8 pt-20'>
      ...
      <div className='flex justify-between flex-col md:flex-row gap-6 lg:gap-10 mb-10'>
        {post ? (
          <>
            {" "}
            {/* <Post post={post[0]} /> */}
            <ThreeDCardDemo data={post[0]} />
            <ThreeDCardDemo data={post[2]} />
            <ThreeDCardDemo data={post[3]} />
            {/* <Post post={post[2]} /> */}
            {/* <Post post={post[3]} /> */}
          </>
        ) : (
...
function Moving() {
  return (
    <div id='page2' className='hidden md:block md:mb-[20vh]'>
      <div id='moving-text'>
        <div className='con uppercase'>
          <h1>Ecosystem</h1>
          <div id='gola' className='h-6 w-6 md:h-20 md:w-20 '></div>
          <h1>Empowerment</h1>
          <div id='gola' className='h-6 w-6 md:h-20 md:w-20 '></div>
          <h1>Self-Reliance</h1>
          <div id='gola' className='h-6 w-6 md:h-20 md:w-20 '></div>
      ...
      <div id='page2-bottom'>
        <h1>
          Fostering leadership, and driving innovation for a self-reliant India
          through sand tank startup foundation.
        </h1>
        <div id='bottom-part2'>
          <img
          ...
          />
          <p>
            As a Section-8 company, we offer courses in effective communication,
            problem-solving, and overall entrepreneurial development. Join us to
            catalyze change, building a self-sufficient India through innovation
            and empowerment.
          </p>
        </div>
      </div>
      ...
      <div className='mx-auto max-w-screen-xlpy-12 sm:px-6 lg:px-8 lg:py-16 '>
        ...
        {review ? (
          <div className='mt-8 grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-8 pb-8'>
            <Review key={0} review={review[1]} />
            <Review key={1} review={review[2]} />
            <Review key={2} review={review[3]} />
          </div>
        ) : (
          ""
        )}
  ...
  return (
    <div id='about' className='md:p-6'>
      ...
      <div className='flex flex-col md:flex-row mb-8 md:mb-20 bg-white'>
        ...
        <div className='hidden bg-[#F3F5F8] md:block w-1/2'>
          <img
            src='https://cdn.dribbble.com/users/650545/screenshots/2593483/rocket__1_.gif'
            alt=''
...
export function Patners() {
  return (
    <section className='p-6 mb-32 text-gray-800'>
      <div className='container p-4 mx-auto text-center'>
        <h2 className='text-2xl md:text-5xl underline font-bold my-10'>
          Our Patners
        </h2>
      </div>
      <div className='container flex flex-wrap justify-center mx-auto text-gray-400'>
        <div className='flex justify-center w-1/2 p-6 align-middle md:w-1/3 xl:w-1/4 border-r-2 border-gray-400'>
          <svg
            xmlns='http://www.w3.org/2000/svg'
            viewBox='0 0 32 32'
